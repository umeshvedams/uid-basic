...
std::string AlljoynMessage;

UIDUtils *myObj = new UIDUtils();
...
void NotificationReceiverTestImpl::Receive(Notification const& notification) {
	...
	/**************************Insert Notifcation Details in Struture******************************/
	
	myObj->setAJNotificationDataField("MessageId",std::to_string(notification.getMessageId()).c_str());
	myObj->setAJNotificationDataField("DeviceId", (const char *)notification.getDeviceId());
	myObj->setAJNotificationDataField("DeviceName",(const char *) notification.getDeviceName());
	myObj->setAJNotificationDataField("AppId",(const char *) notification.getAppId());
	myObj->setAJNotificationDataField("AppName",(const char *) notification.getAppName());
	myObj->setAJNotificationDataField("SenderBusName",(const char *) notification.getSenderBusName());
	myObj->setAJNotificationDataField("MessageType",(const char *)MessageTypeUtil::getMessageTypeString(notification.getMessageType()).c_str());
	myObj->setAJNotificationDataField("NotificationVersion",std::to_string(notification.getVersion()).c_str());


	/***************************Print notification Data ****************************************/	

	std::cout << "Message Id: " << myObj->getAJNotificationDataField("MessageId") << std::endl;
	std::cout << "DeviceId: " << myObj->getAJNotificationDataField("DeviceId") << std::endl;
	std::cout << "DeviceName: " << myObj->getAJNotificationDataField("DeviceName") << std::endl;
	std::cout << "AppId: " << myObj->getAJNotificationDataField("AppId") << std::endl;
	std::cout << "AppName: " << myObj->getAJNotificationDataField("AppName") << std::endl;
	std::cout << "SenderBusName: " << myObj->getAJNotificationDataField("SenderBusName") << std::endl;
	std::cout << "MessageType: " << myObj->getAJNotificationDataField("MessageType") << std::endl;
	std::cout << "NotificationVersion: " << myObj->getAJNotificationDataField("NotificationVersion") << std::endl;
	    ...
	    AlljoynMessage = (std::string) vecMessage_it->getText().c_str();
	    myObj->setAJNotificationDataField("Message",AlljoynMessage);
	    std::cout << myObj->getAJNotificationDataField("Message");	  
	    
        }
	
	/****************************Insert into database ***************/

	myObj->insertAJNotificationDataToDb();
