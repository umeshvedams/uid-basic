...
/*
QStatus AboutPropertyStoreImpl::setStatus(const qcc::String& status, bool isPublic, bool isWritable, bool isAnnouncable)
{

    PropertyStoreKey propertyKey = STATUS;

    return setProperty(STATUS, status, isPublic, isWritable, isAnnouncable);
