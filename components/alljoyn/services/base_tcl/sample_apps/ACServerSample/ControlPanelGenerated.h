...
case EN_MYDEVICE_TURNFANON_GET_VALUE: \
case EN_MYDEVICE_TURNFANOFF_GET_VALUE: \
...
case MYDEVICE_NOTIFICATION_ACTION_TURNFANON_GET_VALUE: \
case MYDEVICE_NOTIFICATION_ACTION_TURNFANOFF_GET_VALUE: \
...
case MYDEVICE_NOTIFICATION_ACTION_TURNFANON_SET_VALUE: \
case EN_MYDEVICE_TURNFANON_SET_VALUE: \
case MYDEVICE_NOTIFICATION_ACTION_TURNFANOFF_SET_VALUE: \
case EN_MYDEVICE_TURNFANOFF_SET_VALUE: \
...
#define AJCPS_CONTROLLEE_GENERATED_OBJECTS \
    ...
    {  MyDeviceTurnFanOnObjectPath, NotificationActionInterfaces  }, \
    {  enMyDeviceTurnFanOnObjectPath, DialogInterfaces  }, \
    {  MyDeviceTurnFanOffObjectPath, NotificationActionInterfaces  }, \
    {  enMyDeviceTurnFanOffObjectPath, DialogInterfaces  }, \


#define AJCPS_CONTROLLEE_GENERATED_OBJECTS_COUNT               14
...
#define MYDEVICE_NOTIFICATION_ACTION_TURNFANON_GET_VALUE                  AJ_ENCODE_MESSAGE_ID(AJCPS_OBJECT_LIST_INDEX, 10, 0, AJ_PROP_GET)
#define MYDEVICE_NOTIFICATION_ACTION_TURNFANON_SET_VALUE                  AJ_ENCODE_MESSAGE_ID(AJCPS_OBJECT_LIST_INDEX, 10, 0, AJ_PROP_SET)
#define MYDEVICE_NOTIFICATION_ACTION_TURNFANON_GET_ALL_VALUES             AJ_ENCODE_MESSAGE_ID(AJCPS_OBJECT_LIST_INDEX, 10, 0, AJ_PROP_GET_ALL)
#define MYDEVICE_NOTIFICATION_ACTION_TURNFANON_VERSION_PROPERTY           AJ_ENCODE_PROPERTY_ID(AJCPS_OBJECT_LIST_INDEX, 10, 1, 0)
#define MYDEVICE_NOTIFICATION_ACTION_TURNFANON_SIGNAL_DISMISS             AJ_ENCODE_MESSAGE_ID(AJCPS_OBJECT_LIST_INDEX, 10, 1, 1)

#define EN_MYDEVICE_TURNFANON_GET_VALUE                  AJ_ENCODE_MESSAGE_ID(AJCPS_OBJECT_LIST_INDEX, 11, 0, AJ_PROP_GET)
#define EN_MYDEVICE_TURNFANON_SET_VALUE                  AJ_ENCODE_MESSAGE_ID(AJCPS_OBJECT_LIST_INDEX, 11, 0, AJ_PROP_SET)
#define EN_MYDEVICE_TURNFANON_GET_ALL_VALUES             AJ_ENCODE_MESSAGE_ID(AJCPS_OBJECT_LIST_INDEX, 11, 0, AJ_PROP_GET_ALL)
#define EN_MYDEVICE_TURNFANON_VERSION_PROPERTY           AJ_ENCODE_PROPERTY_ID(AJCPS_OBJECT_LIST_INDEX, 11, 1, 0)
#define EN_MYDEVICE_TURNFANON_STATES_PROPERTY            AJ_ENCODE_PROPERTY_ID(AJCPS_OBJECT_LIST_INDEX, 11, 1, 1)
#define EN_MYDEVICE_TURNFANON_OPTPARAMS_PROPERTY         AJ_ENCODE_PROPERTY_ID(AJCPS_OBJECT_LIST_INDEX, 11, 1, 2)
#define EN_MYDEVICE_TURNFANON_SIGNAL_PROPERTIES_CHANGED  AJ_ENCODE_MESSAGE_ID(AJCPS_OBJECT_LIST_INDEX, 11, 1, 3)
#define EN_MYDEVICE_TURNFANON_MESSAGE_PROPERTY           AJ_ENCODE_PROPERTY_ID(AJCPS_OBJECT_LIST_INDEX, 11, 1, 4)
#define EN_MYDEVICE_TURNFANON_NUM_ACTIONS_PROPERTY       AJ_ENCODE_PROPERTY_ID(AJCPS_OBJECT_LIST_INDEX, 11, 1, 5)
#define EN_MYDEVICE_TURNFANON_EXEC_ACTION1               AJ_ENCODE_MESSAGE_ID(AJCPS_OBJECT_LIST_INDEX, 11, 1, 6)
#define EN_MYDEVICE_TURNFANON_EXEC_ACTION2               AJ_ENCODE_MESSAGE_ID(AJCPS_OBJECT_LIST_INDEX, 11, 1, 7)
#define EN_MYDEVICE_TURNFANON_EXEC_ACTION3               AJ_ENCODE_MESSAGE_ID(AJCPS_OBJECT_LIST_INDEX, 11, 1, 8)

#define MYDEVICE_NOTIFICATION_ACTION_TURNFANOFF_GET_VALUE                  AJ_ENCODE_MESSAGE_ID(AJCPS_OBJECT_LIST_INDEX, 12, 0, AJ_PROP_GET)
#define MYDEVICE_NOTIFICATION_ACTION_TURNFANOFF_SET_VALUE                  AJ_ENCODE_MESSAGE_ID(AJCPS_OBJECT_LIST_INDEX, 12, 0, AJ_PROP_SET)
#define MYDEVICE_NOTIFICATION_ACTION_TURNFANOFF_GET_ALL_VALUES             AJ_ENCODE_MESSAGE_ID(AJCPS_OBJECT_LIST_INDEX, 12, 0, AJ_PROP_GET_ALL)
#define MYDEVICE_NOTIFICATION_ACTION_TURNFANOFF_VERSION_PROPERTY           AJ_ENCODE_PROPERTY_ID(AJCPS_OBJECT_LIST_INDEX, 12, 1, 0)
#define MYDEVICE_NOTIFICATION_ACTION_TURNFANOFF_SIGNAL_DISMISS             AJ_ENCODE_MESSAGE_ID(AJCPS_OBJECT_LIST_INDEX, 12, 1, 1)

#define EN_MYDEVICE_TURNFANOFF_GET_VALUE                  AJ_ENCODE_MESSAGE_ID(AJCPS_OBJECT_LIST_INDEX, 13, 0, AJ_PROP_GET)
#define EN_MYDEVICE_TURNFANOFF_SET_VALUE                  AJ_ENCODE_MESSAGE_ID(AJCPS_OBJECT_LIST_INDEX, 13, 0, AJ_PROP_SET)
#define EN_MYDEVICE_TURNFANOFF_GET_ALL_VALUES             AJ_ENCODE_MESSAGE_ID(AJCPS_OBJECT_LIST_INDEX, 13, 0, AJ_PROP_GET_ALL)
#define EN_MYDEVICE_TURNFANOFF_VERSION_PROPERTY           AJ_ENCODE_PROPERTY_ID(AJCPS_OBJECT_LIST_INDEX, 13, 1, 0)
#define EN_MYDEVICE_TURNFANOFF_STATES_PROPERTY            AJ_ENCODE_PROPERTY_ID(AJCPS_OBJECT_LIST_INDEX, 13, 1, 1)
#define EN_MYDEVICE_TURNFANOFF_OPTPARAMS_PROPERTY         AJ_ENCODE_PROPERTY_ID(AJCPS_OBJECT_LIST_INDEX, 13, 1, 2)
#define EN_MYDEVICE_TURNFANOFF_SIGNAL_PROPERTIES_CHANGED  AJ_ENCODE_MESSAGE_ID(AJCPS_OBJECT_LIST_INDEX, 13, 1, 3)
#define EN_MYDEVICE_TURNFANOFF_MESSAGE_PROPERTY           AJ_ENCODE_PROPERTY_ID(AJCPS_OBJECT_LIST_INDEX, 13, 1, 4)
#define EN_MYDEVICE_TURNFANOFF_NUM_ACTIONS_PROPERTY       AJ_ENCODE_PROPERTY_ID(AJCPS_OBJECT_LIST_INDEX, 13, 1, 5)
#define EN_MYDEVICE_TURNFANOFF_EXEC_ACTION1               AJ_ENCODE_MESSAGE_ID(AJCPS_OBJECT_LIST_INDEX, 13, 1, 6)
#define EN_MYDEVICE_TURNFANOFF_EXEC_ACTION2               AJ_ENCODE_MESSAGE_ID(AJCPS_OBJECT_LIST_INDEX, 13, 1, 7)
#define EN_MYDEVICE_TURNFANOFF_EXEC_ACTION3               AJ_ENCODE_MESSAGE_ID(AJCPS_OBJECT_LIST_INDEX, 13, 1, 8)
...
extern const char MyDeviceTurnFanOnObjectPath[];
extern const char enMyDeviceTurnFanOnObjectPath[];
extern const char MyDeviceTurnFanOffObjectPath[];
extern const char enMyDeviceTurnFanOffObjectPath[];
...
extern DialogWidget MyDeviceTurnFanOn;
extern DialogWidget MyDeviceTurnFanOff;
